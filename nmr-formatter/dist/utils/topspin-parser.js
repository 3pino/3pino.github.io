...
exports.isTopSpinData = isTopSpinData;
exports.parseTopSpinDirectory = parseTopSpinDirectory;
exports.parseTopSpinXML = parseTopSpinXML;
exports.parseTopSpinMetadata = parseTopSpinMetadata;
    ...
    for (const line of lines) {
        ...
        if (trimmedLine.startsWith('SOLVENT')) {
            ...
            if (parts.length >= 2) {
                ...
                const solvent = (0, constants_1.extractSolventHTMLFromText)(solventText);
                if (solvent) {
        ...
        if (trimmedLine.startsWith('NUC1')) {
            ...
            if (parts.length >= 2) {
                ...
                const nuclei = (0, constants_1.extractNucleiHTMLFromText)(nucleiText);
                if (nuclei) {
...
//# sourceMappingURL=topspin-parser.js.map